...
echo "Creadby  : TU4N.FL4Y $white                                      " |lolcat
echo "Contact  : 0856xxxxxxxx   $white                             " |lolcat
echo "_____________________________________________________________"
...
6) echo "created by : TU4N.FL4Y" | lolcat
exit
;;

*) echo "system is not found"
esac
done
done
